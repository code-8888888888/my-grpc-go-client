...
import (
	...
	"github.com/code-8888888888/my-grpc-go-client/internal/port"
...
func (a *HelloAdapter) SayManyHellos(ctx context.Context, name string) (*hello.HelloResponse, error) {
...
func (a *HelloAdapter) SayHelloContinuos(ctx context.Context, names []string) {
	greetStream, err := a.helloClient.SayHelloContinuos(ctx)
